...
// import { canisterId } from "../declarations/fairbid_v2_backend/index";
...
//         const options = { agent };
//         const actor = await Actor.createActor(idlFactory, { canisterId, ...options });
//         setBackendActor(actor);
//         console.log("Initialized backend actor:", actor);
//         let deposito = await actor.deposit_principal(canisterId);
...
//       try {
//         let deposito = await backendActor.deposit_principal(canisterId);
//         setPrincipal(deposito);
//       } catch (err) {
//         console.error('Error fetching deposit principal:', err);
//         setError(`Failed to fetch deposit principal: ${(err).message}`);
...
//   });
  ...
  // console.log("Contract Write Hook:", { data, isLoading, write });
